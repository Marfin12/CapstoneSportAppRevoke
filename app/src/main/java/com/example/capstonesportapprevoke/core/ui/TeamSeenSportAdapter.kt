...
import com.example.capstonesportapprevoke.databinding.ItemNewFeatureBinding

class TeamSeenSportAdapter : RecyclerView.Adapter<TeamSeenSportAdapter.ListViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) =
        ListViewHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.item_new_feature, parent, false)
        )
    ...
    inner class ListViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val binding: ItemNewFeatureBinding = ItemNewFeatureBinding.bind(itemView)
        fun bind(data: Team) {
            with(binding) {
                with(incSportImage) {
